...
use glam::{Vec2, Vec3, UVec2, IVec2, Vec4, Quat, Mat4};
...
impl Encoder for &mut dyn Encoder {
    fn write_byte(&mut self, value: u8) -> Result<(), EncoderError> { (*self).write_byte(value) }
    fn write_bytes(&mut self, value: &[u8]) -> Result<(), EncoderError> { (*self).write_bytes(value) }
    fn write_f32(&mut self, value: f32) -> Result<(), EncoderError> { (*self).write_f32(value) }
    fn write_f64(&mut self, value: f64) -> Result<(), EncoderError> { (*self).write_f64(value) }
    fn write_u32(&mut self, value: u32) -> Result<(), EncoderError> { (*self).write_u32(value) }
    fn write_u64(&mut self, value: u64) -> Result<(), EncoderError> { (*self).write_u64(value) }
}

impl Decoder for &mut dyn Decoder {
    fn read_byte(&mut self) -> Result<u8, DecoderError> { (*self).read_byte() }
    fn read_bytes(&mut self, count: usize) -> Result<&[u8], DecoderError> { (*self).read_bytes(count) }
    fn read_f32(&mut self) -> Result<f32, DecoderError> { (*self).read_f32() }
    fn read_f64(&mut self) -> Result<f64, DecoderError> { (*self).read_f64() }
    fn read_u32(&mut self) -> Result<u32, DecoderError> { (*self).read_u32() }
    fn read_u64(&mut self) -> Result<u64, DecoderError> { (*self).read_u64() }
}
...
impl Serialize for () {
    type Header = ();
    fn serialize(&self, _encoder: &mut impl Encoder) -> Result<(), EncoderError> { Ok(()) }
    fn deserialize(_decoder: &mut impl Decoder, _header: &Self::Header) -> Result<(), DecoderError> { Ok(()) }
}
...
impl<A: Serialize, B: Serialize> Serialize for (A, B) {
    ...
    fn deserialize(decoder: &mut impl Decoder, header: &Self::Header) -> Result<Self, DecoderError> {
        Ok((A::deserialize(decoder, &header.0)?, B::deserialize(decoder, &header.1)?))
    }
}
...
impl<A: Serialize, B: Serialize, C: Serialize> Serialize for (A, B, C) {
    ...
    fn deserialize(decoder: &mut impl Decoder, header: &Self::Header) -> Result<Self, DecoderError> {
        Ok((A::deserialize(decoder, &header.0)?, B::deserialize(decoder, &header.1)?, C::deserialize(decoder, &header.2)?))
    }
}
...
impl<A: Serialize, B: Serialize, C: Serialize, D: Serialize> Serialize for (A, B, C, D) {
    ...
    fn deserialize(decoder: &mut impl Decoder, header: &Self::Header) -> Result<Self, DecoderError> {
        Ok((A::deserialize(decoder, &header.0)?, B::deserialize(decoder, &header.1)?, C::deserialize(decoder, &header.2)?, D::deserialize(decoder, &header.3)?))
    }
}
...
impl<K: Serialize + core::hash::Hash + core::cmp::Eq + core::cmp::Ord, V: Serialize> Serialize for BTreeMap<K, V> {

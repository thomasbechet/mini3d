...
use mini3d_core::input::provider::InputProvider;
...
impl InputProvider for WinitInputProvider {
    ...
    fn add_action(&mut self, id: u32, action: &mini3d_core::feature::input::action::InputAction) {
        self.0.borrow_mut().add_action(id, action);
    }

    fn add_axis(&mut self, id: u32, axis: &mini3d_core::feature::input::axis::InputAxis) {

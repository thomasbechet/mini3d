use mini3d::{
    ...
    math::rect::IRect,
    registry::{component::StaticComponentType, system::ExclusiveSystem},
...
#[derive(Default)]
struct OSInitialize {
    font: StaticComponentType<Font>,
    material: StaticComponentType<Material>,
    texture: StaticComponentType<Texture>,
    mesh: StaticComponentType<Mesh>,
    model: StaticComponentType<Model>,
    lifecycle: StaticComponentType<Lifecycle>,
    ...
    ui_render_target: StaticComponentType<UIRenderTarget>,
    script: StaticComponentType<Script>,

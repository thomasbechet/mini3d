...
pub trait RendererProvider {
    ...
    fn add_mesh(&mut self, data: &Mesh) -> Result<RendererProviderHandle, RendererProviderError>;
    ...
    fn add_font(&mut self, data: &Font) -> Result<RendererProviderHandle, RendererProviderError>;

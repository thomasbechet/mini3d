...
impl Registry {
    ...
    pub(crate) fn set(&mut self, e: Entity, id: ComponentId) {
        self.bitsets
            .get_mut(id)
            .unwrap()
    ...
    pub(crate) fn unset(&mut self, e: Entity, id: ComponentId) {
        self.bitsets
            .get_mut(id)
            .unwrap()
    ...
    pub(crate) fn mask(&self, id: ComponentId, index: usize) -> u32 {
        self.bitsets[id].mask(index)
    }
}
